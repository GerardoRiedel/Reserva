...
//$db['default']['hostname'] = 'www.cetep.cl';
//$db['default']['username'] = 'cetepcl';
//$db['default']['password'] = 'rootsecurity626';
$db['default']['hostname'] = 'localhost';
$db['default']['username'] = 'root';
$db['default']['password'] = '';
$db['default']['database'] = 'cetepcl_agenda_uac';
...
$db['capacitacion']['hostname'] = 'www.cetep.cl';
$db['capacitacion']['username'] = 'cetepcl';
$db['capacitacion']['password'] = 'rootsecurity626';
