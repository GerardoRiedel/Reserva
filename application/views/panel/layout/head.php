...
<?php IF(empty($title))$title = 'Cetep'; ?>
   ...
   .caja{
     ...
     .cajaCabeza{
         background-color: rgb(52, 180, 77);
         color:white;
         height: 50px;
...
<div class=" header header" >
    <div class="col-lg-12 noCelular" style="margin-top:-40px"></div>
    <div class="col-lg-2"></div>
    <div  class="col-lg-8" style="background-color: black;height: 30px;margin-top:40px;padding-top: 5px" >
        <a href="http://www.cetep.cl/web/?page_id=39" style="color:white;margin-left:25%;padding-top: 5px;cursor: pointer"><b>Centro Médico</b></a>
    </div>
    <div class="col-lg-12 celular"></div>
    
    <div class="col-lg-2 celular"></div>
    <div class="col-lg-9 celular" style="margin-top:-18px">
        <a href="http://www.cetep.cl/web/?page_id=39" style="cursor: pointer">
            <img  style="width: 160px;" src="<?php echo base_url();?>../assets/img/logo_vertical_cetep.png" />
            <img src="http://www.cetep.cl/web/wp-content/uploads/2015/10/Mentalizados.png" style='margin-top:25px; margin-left:170px'>
        </a>
    </div>
